    ...
    >
      <div className="mb-8 md:mb-0">
        <h3 className="md:text-5xl text-2xl font-bold overflow-hidden uppercase pb-8">
          <SlideIn>
            <OpacityTextReveal>
              Live the Brand. Lead the Market.
            </OpacityTextReveal>
          </SlideIn>
        </h3>
        <Transition
        ...
        >
          <OpacityTextReveal>
            At Nexomark, we don’t just build brands—we craft experiences that
            define industries. From cutting-edge design and development to
            strategic growth and market dominance, we create solutions that set
            businesses apart. Whether it’s a compelling brand identity, a
            high-performance website, or a results-driven marketing strategy, we
        ...
        <div className="sticky top-6">
          <Transition>
            <video
              ...
              muted
              playsInline
              className="rounded-xl max-h-[550px] "
            >
