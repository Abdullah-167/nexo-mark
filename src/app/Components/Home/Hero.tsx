    ...
    >
      ...
      <div className="container relative z-10 px-6">
        ...
        >
          ...
          >
            A creative digital agency focused on meaningful work for ambitious brands.
          </motion.p>
      ...
      >
        ...
        >
          <span className="text-xs text-neutral-500 mb-1 tracking-widest">SCROLL</span>
          <svg width="16" height="24" viewBox="0 0 16 24" fill="none" className="text-neutral-400">
            <path
